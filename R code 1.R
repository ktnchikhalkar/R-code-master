...
xyz <- read.csv("C:/Users/Ketan/Downloads/data science/Datasets/mba.csv") # load csv file into R
...
spss <- read.spss("C:/Users/Ketan/Downloads/data science/Datasets/Cancer.csv")

spss

View(spss)
spss1 <- read.spss("C:/Users/Ketan/Downloads/data science/Datasets/Cancer.csv", to.data.frame = T, use.value.labels = T)
