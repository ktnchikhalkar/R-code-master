...
# C:\Users\Ketan\Data Science\datasets\mba.csv - this is windows default file path with a '\'
# C:\Users\\Ketan\\Data Science\datasets\mba.csv - change it to '\\' to make it work in R
